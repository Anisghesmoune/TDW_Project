        ...
        <div class="footer-auth">
            ...
            <ul class="auth-links" style="list-style:none; padding:0;">
                <li style="margin-bottom:10px;">
                    <a href="index.php?route=login" class="btn-login" style="display:inline-block; background:rgba(255,255,255,0.1); padding:8px 15px; border-radius:5px; text-decoration:none; color:white;">
                        <i class="fas fa-sign-in-alt"></i> Se connecter
                    </a>
                </li>
                
                <li style="margin-bottom:10px;">
                    <a href="index.php?route=register" class="btn-login" style="display:inline-block; background:rgba(255,255,255,0.1); padding:8px 15px; border-radius:5px; text-decoration:none; color:white;" ><i class="fas fa-sign-in-alt"></i> Se connecterCréer un compte</a>
                </li> 
